    ...
    <div class="header-top-inner">
        ...
        <ul class="list-unstyled">
            @if (session()->get('language') == 'bangla')
                <li><a href="{{ route('dashboard') }}"><i class="icon fa fa-user"></i>আমার অ্যাকাউন্ট</a></li>
            @else
        ...
        <div class="dropdown dropdown-cart"> <a href="#" class="dropdown-toggle lnk-cart" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
                <li>
                    ...
                    <div class="pull-right"> <span class="text">Sub Total :</span class="sign">$<span class='price' id="cartSubTotal"></span> </div>
                    <div class="clearfix"></div>
    ...
    <div class="yamm navbar navbar-default" role="navigation">
        ...
        <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            ...
            <ul class="nav navbar-nav">
                <li class="active dropdown yamm-fw"> <a href="{{ route('home') }}" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown">
                    @if (session()->get('language') == 'bangla')
                    হোম
                    @else
                    Home
